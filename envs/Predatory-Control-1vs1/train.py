...
if __name__ == "__main__":
    ...
    dim = 10
    env = defendCircle(len=10,r_=2 ,fmax=0.85)
    writer = SummaryWriter(comment="PredatoryControl-1vs1-"+str(os.getpid()))
    ...
    env = defendCircle(len=500,r_=50,vmax=50,fmax=0.85,random_=False)
    state = env.reset()
